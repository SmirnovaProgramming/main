...
const int Quantity_Reserved_Names = 22; //значение должно быть константой, так как используется как размер массива.
const int Quantity_Forbidden_Characters = 9; //значение должно быть константой, так как используется как размер массива.
